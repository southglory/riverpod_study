...
import '../todo_filter/todo_filter_provider.dart';
import '../todo_list/todo_list_provider.dart';
import '../todo_search/todo_search_provider.dart';
...
List<Todo> filteredTodos(FilteredTodosRef ref) {
  ...
  if (search.isNotEmpty) {
    tempTodos = tempTodos.where((todo) => todo.desc.toLowerCase().contains(search.toLowerCase())).toList();
  }
